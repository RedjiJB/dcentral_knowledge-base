...
status: superseded
superseded_by: "D-Central-Complete-Fractal-DAO-Governance-Architecture-md-7edde1e7.md [unresolved during reconciliation -- old path, target not found in new tree]"
supersession_reason: Same title re-uploaded same project 24min later, 2.5x content (77116 vs 30721 chars).
---
