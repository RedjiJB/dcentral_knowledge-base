...
content_hash: 2969c569d258superseded_docs: [drone-selection-guide2-md.md]topic: savings-crazyflie-folding
...
|-----------|-----------------|-----|------------|-----|---------------|
| Pi HQ Camera | 12MP, Sony IMX477 | 1 | $50 | 6,550 | âŒ |
| Custom Lens Set | 16mm, 25mm, 35mm | 3 | $120 | 15,720 | âŒ |
| 3D Printed Housing | PLA, Weatherproof Design | 1 | $15 | 1,965 | âœ… |
| Servo Motors | MG996R x3 | 3 | $30 | 3,930 | âŒ |
| Control Board | Arduino Nano | 1 | $8 | 1,048 | âŒ |
| Wiring Harness | Custom Cable Set | 1 | $12 | 1,572 | âŒ |
...
| Component | Open Source Spec | Qty | Cost (USD) | HTG | 3D Printable? |
|-----------|-----------------|-----|------------|-----|---------------|
| MLX90640 Sensor | 32x24, -40Â°C to 300Â°C | 1 | $65 | 8,515 | âŒ |
| ESP32 Wrover | 8MB Flash + PSRAM | 1 | $12 | 1,572 | âŒ |
| TFT Display | 2.4" 320x240 ILI9341 | 1 | $15 | 1,965 | âŒ |
| 3D Printed Housing | PETG, Thermal Resistant | 1 | $20 | 2,620 | âœ… |
| Lens System | Germanium Lens 25mm | 1 | $45 | 5,895 | âŒ |
| PCB + Components | Custom PCB + Parts | 1 | $35 | 4,585 | âŒ |
| Battery System | Li-Po + Charging Circuit | 1 | $25 | 3,275 | âŒ |
...
| Component | Open Source Spec | Qty | Cost (USD) | HTG | 3D Printable? |
|-----------|-----------------|-----|------------|-----|---------------|
| Pi Camera V3 NoIR | IR Sensitive, 12MP | 1 | $35 | 4,585 | âŒ |
| IR LED Array | 850nm, 3W Total | 6 | $18 | 2,358 | âŒ |
| 2" TFT Display | NTSC Input, 320x240 | 1 | $25 | 3,275 | âŒ |
| 3D Printed Housing | OpenScope Design | 1 | $25 | 3,275 | âœ… |
| Optics System | 38mm Lens + Filters | 1 | $40 | 5,240 | âŒ |
| Control Electronics | Arduino + Video Mixer | 1 | $30 | 3,930 | âŒ |
| Power System | 9V + Voltage Regulator | 1 | $15 | 1,965 | âŒ |
...
|-----------|---------------|-----|------------|-----|---------------|
| Thermal Base | OS-2 Module | 1 | $217 | 28,427 | âœ… |
| Night Vision Base | OS-3 Module | 1 | $188 | 24,628 | âœ… |
| Fusion Processor | Raspberry Pi 4 8GB | 1 | $75 | 9,825 | âŒ |
| Video Mixer | Custom PCB Design | 1 | $45 | 5,895 | âŒ |
| 3D Printed Housing | Integrated Dual Design | 1 | $35 | 4,585 | âœ… |
...
| Component | Open Source Spec | Qty | Cost (USD) | HTG | 3D Printable? |
|-----------|-----------------|-----|------------|-----|---------------|
| Pi Camera V2 RGB | 8MP Sony IMX219 | 1 | $25 | 3,275 | âŒ |
| Pi Camera V2 NoIR | 8MP, IR Sensitive | 1 | $30 | 3,930 | âŒ |
| Filter Set | Rosco 2007 + Custom | 5 | $35 | 4,585 | âŒ |
| Pi Compute Module | CM3+ with eMMC | 1 | $55 | 7,205 | âŒ |
| 3D Printed Housing | Dual Camera Mount | 1 | $20 | 2,620 | âœ… |
| Lens System | M12 Mount Lenses | 2 | $30 | 3,930 | âŒ |
| Control Electronics | CM IO Board + Parts | 1 | $40 | 5,240 | âŒ |
| **TOTAL** | | | **$235** | **30,785** | **Housing: 100%** |
...
| Component | Open Source Spec | Qty | Cost (USD) | HTG | 3D Printable? |
|-----------|-----------------|-----|------------|-----|---------------|
| VL53L0X Sensors | Time-of-Flight, 2m Range | 2 | $20 | 2,620 | âŒ |
| Stepper Motor | 28BYJ-48 + Driver | 1 | $8 | 1,048 | âŒ |
| Arduino Nano | Control + Serial Comm | 1 | $8 | 1,048 | âŒ |
| 3D Printed Parts | Complete Housing System | 1 | $30 | 3,930 | âœ… |
| Ball Bearing | 6807 ZZ, 35mm ID | 1 | $12 | 1,572 | âŒ |
| Slip Ring | 4-wire, 12.5mm Dia | 1 | $25 | 3,275 | âŒ |
| Electronics | PCB + Components | 1 | $20 | 2,620 | âŒ |
...
| **ADVANCED TOTAL** | | | **$218** | **28,557** | **2m Range, Â±2cm** |
...
| Component | Specification | Qty | Cost (USD) | HTG | 3D Printable? |
|-----------|---------------|-----|------------|-----|---------------|
| Edge AI Computer | NVIDIA Jetson Nano | 1 | $99 | 12,969 | âŒ |
| High-Res Camera | Pi HQ Camera + Lens | 1 | $80 | 10,480 | âŒ |
| AI Accelerator | Intel Neural Compute Stick | 1 | $79 | 10,349 | âŒ |
| 3D Printed Housing | AI Computer Enclosure | 1 | $25 | 3,275 | âœ… |
| Thermal Management | Active Cooling System | 1 | $20 | 2,620 | âŒ |
| Storage | 128GB microSD + SSD | 1 | $35 | 4,585 | âŒ |
...
| Component | Specification | Qty | Cost (USD) | HTG | 3D Printable? |
|-----------|---------------|-----|------------|-----|---------------|
| 4G/5G Modem | Quectel RM500Q-GL | 1 | $120 | 15,720 | âŒ |
| WiFi Mesh Router | GL.iNet GL-B1300 | 1 | $65 | 8,515 | âŒ |
| SDR Module | HackRF One | 1 | $320 | 41,920 | âŒ |
| 3D Printed Housing | RF Transparent Enclosure | 1 | $20 | 2,620 | âœ… |
| Antenna Array | Multi-band Antennas | 4 | $60 | 7,860 | âŒ |
| Power Management | DC-DC Converters | 1 | $25 | 3,275 | âŒ |
...
| Component         | Open Source Option 1                | Specs (Option 1)         | Cost (USD) | Open Source Option 2 / Cost | Open Source Option 3 / Cost | Proprietary Alternative (Specs)         | Cost (USD) |
|-------------------|-------------------------------------|--------------------------|------------|----------------------------|----------------------------|-----------------------------------------|------------|
| Thermal Sensor    | MLX90640                           | 32x24, -40Â°C to 300Â°C    | $65        | MLX90641 / $45             | AMG8833 / $20              | FLIR Boson 640 (640x512, 60Hz)          | $3,200     |
...
| Component         | Open Source Option 1                | Specs (Option 1)         | Cost (USD) | Open Source Option 2 / Cost | Open Source Option 3 / Cost | Proprietary Alternative (Specs)         | Cost (USD) |
|-------------------|-------------------------------------|--------------------------|------------|----------------------------|----------------------------|-----------------------------------------|------------|
| Distance Sensor   | VL53L0X ToF Sensor                  | 2m range, I2C            | $40        | Triangulation + Laser / $25| TOF Laser + APD / $50      | Livox Mid-360 (360Â°, 260m, 100k pts/s)  | $1,500     |
